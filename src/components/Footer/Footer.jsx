                ...
                <Row className="gy-4">
                    <Col lg={4} md={12}>
                        <div className="d-flex align-items-center mb-2">
                            ...
                            <h4 className="mb-0 px-3">Nacer Salud</h4>
                        </div>
                    ...
                    <Col lg={3} md={4}>
                        ...
                        <ul className="list-unstyled text-white-50">
                            <li>📞 +541124973529</li>
                            <li>📧 infonacersalud@gmail.com</li>
                    ...
                    <Col lg={3} md={4}>
                        ...
                        <div>
                            ...
                            <a href="https://wa.me/5491124973529?text=Hola%21%20Quisiera%20recibir%20m%C3%A1s%20informaci%C3%B3n" target="_blank" aria-label="Contactar por WhatsApp" className="wapp-link">
